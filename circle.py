...
class Circle:
    def __init__(self, x, y, radius):
        if not isinstance(x, (int, float)) or not isinstance(y, (int, float)) or not isinstance(radius, (int, float)):          #Validates x, y, and radius are numbers
    ...
    def is_unit_circle(self):
        """Return True if the circle has a radius of 1."""
